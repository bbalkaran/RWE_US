...
NHWS_Med_Pharm$client_patient_id %>% n_distinct() #574
NHWS_Med_Pharm$zkey %>% n_distinct() # 574
...
CohortA2 <- NHWS_Med_Pharm #574


save(CohortA2, file = "C:/Users/BalkaranB/Kantar/Arunajadai, Srikesh (KH) - RWE_US/Lilly_migraine_prevention_161103482_2/CohortA2.RData")
